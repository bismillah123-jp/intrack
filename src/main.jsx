      ...
      <section className="balance-hero">
        <div className="balance-hero-top">
          ...
          <button
            ...
            onClick={() => {
              const nextHidden = !ui.balanceHidden;
              localStorage.setItem("dompetrapi-hidden", String(nextHidden));
              setUi(c => ({ ...c, balanceHidden: nextHidden }));
            }}
          >
    ...
    <div className="pro-lab-single">
      ...
      {activeTab === "receipt" ? (
        <section className={`panel ai-panel receipt-panel ${!isPro ? "locked-panel" : ""}`}>
          ...
          {!ui.scanResult && <AiOutput lines={Array.isArray(ui.receipt) ? ui.receipt : ui.receipt ? [ui.receipt] : []} />}
