...
function AccountPanel({ profile, demo, plan, backend, theme, setTheme, onLogout, setUi, onUpdateProfile, onUpdatePassword }) {
      ...
      <section className="panel form-panel">
        ...
        {!showProfile ? (
          ...
          <SmartForm
            ...
            onSubmit={(values) => { onUpdateProfile(values); setShowProfile(false); }}
          />
        )}
      </section>
      ...
      <section className="panel form-panel">
        ...
        {!showPassword ? (
          ...
          <SmartForm
            ...
            onSubmit={(values) => { onUpdatePassword(values); setShowPassword(false); }}
          />
        )}
      </section>
